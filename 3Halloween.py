...
while True:
    ...
    if cycle_pick == 1:
        ...
        colorloop(one_red_color, one_blue_color, one_green_color, off_red_color,
                  off_blue_color, off_green_color, sleeptime)

    if cycle_pick == 2:

        colorloop(off_red_color, off_blue_color, off_green_color, two_red_color,
                  two_blue_color, two_green_color, sleeptime)

        colorloop(two_red_color, two_blue_color, two_green_color, off_red_color,
                  off_blue_color, off_green_color, sleeptime)

    if cycle_pick == 3:

        colorloop(off_red_color, off_blue_color, off_green_color, three_red_color,
                  three_blue_color, three_green_color, sleeptime)

        colorloop(three_red_color, three_blue_color, three_green_color, off_red_color,
                  off_blue_color, off_green_color, sleeptime)

    if cycle_pick == 4:

        colorloop(off_red_color, off_blue_color, off_green_color, four_red_color,
