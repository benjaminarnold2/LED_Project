...
four_red_color = input("Set value for red: ")
four_green_color = input("Set value for green: ")
four_blue_color = input("Set value for blue: ")
...
while True:
    ...
    colorloop(four_red_color, four_blue_color, four_green_color, one_red_color,
